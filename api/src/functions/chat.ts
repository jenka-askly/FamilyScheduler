...
const isMutationAction = (action: Action): boolean => ['add_appointment', 'delete_appointment', 'update_appointment_desc', 'reschedule_appointment', 'add_people_to_appointment', 'remove_people_from_appointment', 'replace_people_on_appointment', 'clear_people_on_appointment', 'set_appointment_location', 'set_appointment_notes', 'add_availability', 'delete_availability', 'set_identity', 'reset_state'].includes(action.type);
