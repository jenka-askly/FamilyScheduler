...
- 2026-02-18: Re-verified local Functions discovery path expectations; confirmed API build output at `api/dist/src/functions/chat.js` matches worker indexing and documented targeted troubleshooting guidance in runbook.
